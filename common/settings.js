...
export class SettingsTracker {
   ...
   * @param {string} areaName The name of the storage that was changed.
   * @memberof SettingsTracker
   */
   ...
   * @readonly
   * @memberof SettingsTracker
   * @returns {EventSubscriber<[Changes<T>, string]>} An event subscriber that is notified when the tracked settings are changed.
   */
  get onChange() {
...
// @ts-ignore
   ...
   * @static
   * @template T
   * @param {function(Changes<T>, string): any} callback (changes, areaName) Function that will be called when this event occurs. The function will be passed the following arguments:
